<div>
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0 p-0">Cadastrar nova pessoa</h5>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                --}}
                                {{--
                                @if(count($tipo) > 0 && in_array(2, $tipo))
                        ...
                        <div class="card-body p-2">
                            <div class="tab-content">
                                <div class="tab-pane {{ $tab_active == 'tab-dados_gerais' ? 'active' : '' }}" id="tab-dados_gerais">
                                    @include('livewire/atendimento/pessoa/auxiliar/pessoa-criar-dados_gerais')
                                </div>
                                {{--
                                <div class="tab-pane {{ $tab_active == 'tab-contato' ? 'active' : '' }}" id="tab-contato">
                                    @include('livewire/atendimento/pessoa/auxiliar/pessoa-criar-contato')
                                </div>
                                --}}
                                <div class="tab-pane {{ $tab_active == 'tab-endereco' ? 'active' : '' }}" id="tab-endereco">
                                    @include('livewire/atendimento/pessoa/auxiliar/pessoa-criar-endereco')
                                </div>
                                {{--
                                <div class="tab-pane {{ $tab_active == 'tab-tipo' ? 'active' : '' }}" id="tab-tipo">
                                    @include('livewire/atendimento/pessoa/auxiliar/pessoa-criar-funcoes')
                                </div>
                                --}}
                                {{--
                                @if(count($tipo) > 0 && in_array(2, $tipo))
                                <div class="tab-pane {{ $tab_active == 'tab-usuario_sistema' ? 'active' : '' }}" id="tab-usuario_sistema">
                                    @include('livewire/atendimento/pessoa/auxiliar/pessoa-criar-sistema')
                                </div>
                                @endif
                                --}}
                                <div class="tab-pane {{ $tab_active == 'tab-obs' ? 'active' : '' }}" id="tab-obs">
                                    @include('livewire/atendimento/pessoa/auxiliar/pessoa-criar-observacao')
                                </div>
                            </div>
                        </div>
