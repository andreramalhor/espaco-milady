        ...
        <div class="modal-dialog" style="overflow-y: initial !important;">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12" wire:ignore>
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm select2" wire:model.live="id_cliente">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <label for="col-form-label">Serviço <b class="text-red">*</b></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="col-form-label">Profissional <b class="text-red">*</b></label>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-success {{ $criar ? '' : 'disabled' }}" wire:click="store()">Salvar</button>
                </div>
            </div>
        </div>
    </div>
