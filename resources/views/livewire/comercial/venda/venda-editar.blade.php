<div>
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0 p-0">Editar venda</h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Editar venda: {{ $venda->nome_produto }}</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" date="form-control form-control-sm @error('dt_pgto_comissao') is-invalid @enderror" wire:model.live="dt_pgto_comissao">
                        ...
                        <div class="card-footer">
                            <form wire:submit.prevent="edit">
                                <a href="{{  route('com.vendas.index') }}" class="btn btn-sm btn-default float-left">Cancelar</a>
