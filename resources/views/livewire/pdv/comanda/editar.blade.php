              ...
              <div class="col-12">
                <div class="widget-user-header">
                  <div class="widget-user-image text-center">
                    ...
                    <input type="hidden" name="src_foto" id="src_foto" value="">
...
function validar(item)
{
  ...
  .then(function(response)
  {
    ...
    // if(valor == 'instagram')
    // {
    //   let src_foto = $("#src_foto").val();
    //   $("#profile_picture").attr('src', src_foto);
...
function validarISNTA(field)
{
  ...
  if ($('#trocar_foto').is(':checked'))
  {
    ...
    {
      // console.log(response)
      $("#src_foto").val(response.data.graphql.user.profile_pic_url);
      validar(field)
    })
  }
}
