    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-footer">
                <a class="btn btn-sm btn-default" href="{{ url()->previous() }}">Voltar</a>
                <a class="btn btn-sm btn-default" href="{{ route('pdv.comandas.imprimir', $comanda->id) }}" target="_blank" style="color: black;"><i class="fas fa-print"></i> Imprimir</a>
            </div>
        </div>
    </div>
</div>