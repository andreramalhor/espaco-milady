...
function procurar_dados_Cliente()
{
  ...
  //   dados_do_cliente.src_foto = response.data.src_foto;
...
function procurar_dados_ProfissionaisCapacitados( id_produto_servico, mostrar )
{
  ...
  .then( function()
  {
    ...
    {
      let fotoProfissional = '<img src="'+value.src_foto+'" class="img-circle radio" alt="User Image" width="50px" style="margin: 5px;" id="idProfissional_'+value.id+'" data-value="'+value.id+'" onclick="selecionarProfissional(this);" data-bs-tooltip="tooltip" data-bs-title="'+value.apelido+'" data-original-title="'+value.apelido+'">';
...
function preencher_tela_Principal()
{
  ...
  // $("#widget-user-picture").attr('src', dados_do_cliente.src_foto);
