<div>
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0 p-0">Editar Saída: {{ $apelido }}</h5>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-body p-2">
                            <div class="tab-content">
                                <div class="tab-pane {{ $tab_active == 'tab-dados_gerais' ? 'active' : '' }}" id="tab-dados_gerais">
                                    @include('livewire.catalogo.saida.auxiliar.Saida-editar-dados_gerais')
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-contato' ? 'active' : '' }}" id="tab-contato">
                                    @include('livewire.catalogo.saida.auxiliar.Saida-editar-contato')
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-endereco' ? 'active' : '' }}" id="tab-endereco">
                                    @include('livewire.catalogo.saida.auxiliar.Saida-editar-endereco')
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-tipo' ? 'active' : '' }}" id="tab-tipo">
                                    @include('livewire.catalogo.saida.auxiliar.Saida-editar-funcoes')
                                </div>
                                @if(in_array(2, $tipo))
                                <div class="tab-pane {{ $tab_active == 'tab-usuario_sistema' ? 'active' : '' }}" id="tab-usuario_sistema">
                                    @include('livewire.catalogo.saida.auxiliar.Saida-editar-sistema')
                                </div>
                                @endif
                                <div class="tab-pane {{ $tab_active == 'tab-obs' ? 'active' : '' }}" id="tab-obs">
                                    @include('livewire.catalogo.saida.auxiliar.Saida-editar-observacao')
                                </div>
                            </div>
                        </div>
