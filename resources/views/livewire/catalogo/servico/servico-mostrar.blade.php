                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="{{ $servico->src_foto }}" alt="User profile picture"  data-bs-tooltip="tooltip" data-bs-title="{{ $servico->apelido }}">
                            </div>
                        ...
                        <div class="card-body p-2">
                            <div class="tab-content">
                                <div class="tab-pane {{ $tab_active == 'tab-painel' ? 'active' : '' }}" id="tab-painel">
                                    @livewire('Catalogo.Servico.Auxiliar.ServicoPainel', ['servico' => $servico])
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-sobre' ? 'active' : '' }}" id="tab-sobre">
                                    <h1>sobre</h1>
                                    @include('livewire.catalogo.servico.show.01_inc_mostrar_sobre')
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-entradas' ? 'active' : '' }}" id="tab-entradas">
                                    <h6>entradas</h6>
                                    @livewire('Catalogo.Servico.Auxiliar.ServicoEntradas', ['servico' => $servico])
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-saidas' ? 'active' : '' }}" id="tab-saidas">
                                    <h6>Saídas</h6>
                                    @livewire('Catalogo.Servico.Auxiliar.ServicoSaidas', ['servico' => $servico])
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-agendamentos' ? 'active' : '' }}" id="tab-agendamentos">
                                    <h1>agendamentos</h1>
                                {{--
                                    @livewire('Catalogo.Servico.Auxiliar.ServicoAgendamentos', ['servico' => $servico])
                                    --}}    
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-financeiro' ? 'active' : '' }}" id="tab-financeiro">
                                    <h1>financeiro</h1>
                                    {{-- @include('livewire.catalogo.servico.show.inc_mostrar_financeiro') --}}
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-vendas' ? 'active' : '' }}" id="tab-vendas">
                                    <h1>vendas</h1>
                                {{--
                                    @livewire('Catalogo.Servico.Auxiliar.ServicoComandas', ['servico' => $servico])
                                    --}}    
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-comissoes_servicos' ? 'active' : '' }}" id="tab-comissoes_servicos">
                                    <h1>comissoes_servicos</h1>
                                    {{-- @include('livewire.catalogo.servico.show.inc_mostrar_comissoes_p') --}}
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-comissoes_servicos' ? 'active' : '' }}" id="tab-comissoes_servicos">
                                    <h1>comissoes_servicos</h1>
                                    {{-- @include('livewire.catalogo.servico.show.inc_mostrar_comissoes_s') --}}
                                </div>
                                <div class="tab-pane {{ $tab_active == 'tab-tipo' ? 'active' : '' }}" id="tab-tipo">
                                    <h1>tipo</h1>
                                {{--
                                    @livewire('Catalogo.Servico.Auxiliar.ServicoFuncoes', ['servico' => $servico])
                                    --}}    
                                    {{-- @include('livewire.catalogo.servico.show.02_inc_mostrar_tipo') --}}
                                </div>
                            </div>
                        </div>
                    </div>
