<div class="card card-default">
    <div class="card-header">
        <h3 class="card-title">Sobre o serviço</h3>
    </div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    <label for="duracao">Duração <b class="text-danger">*</b></label>
                    <input type="time" class="form-control form-control-sm @error('duracao') is-invalid @enderror" wire:model.live="duracao">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm text-center tempo @error('duracao') is-invalid @enderror" wire:model="duracao" placeholder="Duração do serviço">
                    @error('duracao')<div class="invalid-feedback">{{ $message ?? 'teste de mensagem de erro'}}</div>@enderror
                </div>
            </div>
            @endif
