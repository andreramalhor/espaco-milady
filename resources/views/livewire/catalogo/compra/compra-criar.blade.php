<div>
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0 p-0">Cadastrar nova compra</h5>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm @error('id_fornecedor') is-invalid @enderror" wire:model.live="id_fornecedor">
                                            ...
                                            @foreach(\App\Models\ACL\Funcao::where('nome', '=', 'Fornecedor')->first()->znufwevbqgruklz as $ciclo)
                                ...
                                <div class="col-2">
                                    ...
                                    <form wire:submit.prevent="gravarCompra">
                                        <button type="submit" class="btn btn-sm btn-info float-right @if(is_null($id_fornecedor) || $id_fornecedor == 'null') disabled @endif">Cadastrar</button>
                                    </form>
                                </div>
                            </div>
                        </div>
