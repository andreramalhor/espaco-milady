...
// RELACIONAMENTOS  ===========================================================================================
  ...
  public function lwerwerflkdsjfs()
  {
    return $this->hasManyThrough(
      Pessoa::class,                // Model Final
      ColaboradorServico::class,    // Model Meio
      'id_servprod',                // Chave estrangeira na model Meio ...
      'id',                         // Chave principal na model Final ...
      'id',                         // Chave principal na model que estou ...
      'id_profexec');               // Chave principal na model Meio ...
  }
...
// MUTATORS         ===========================================================================================
  ...
  public function getEstoqueAtualAttribute()
  {
    ...
    $vendido = ComandaDetalhe::where('id_servprod', $this->id)->count();
  ...
  function getsrcFotoAttribute()
  {
      ...
      {
          return asset('storage/app/logo.png');
      }
  }
