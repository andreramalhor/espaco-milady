...
class ServicoCriar extends Component
{
    use WithFileUploads;
    ...
    public function updatedDuracao($value)
    {
      if( $value == "00:00" )
      {
        $this->addError('duracao', 'A duração não pode ser 00:00.');
      }
    }
    ...
    public function store()
    {
      ...
      $servico = DBServicoProduto::create([
        'tipo'                          => $this->tipo,                  
        'nome'                          => $this->nome,                  
      ...
      return redirect()->to(route('cat.servicos.index')); 
    }
    ...
    {
      return view('livewire/catalogo/servico/servico-criar')->layout('layouts/bootstrap');
    }
}
