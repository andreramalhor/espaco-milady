...
class Produto extends Component
{
    ...
    {
        $produto = DBServicoProduto::findOrFail($id);
        $this->produtoId = $id;
    ...
    public function atualizar()
    {
        if ($this->produtoId)
        {
            $produto = DBServicoProduto::findOrFail($this->produtoId);
            $produto->update([
                'nome'                          => $this->bd_nome,
                'tipo'                          => $this->bd_tipo,
                'ativo'                         => $this->bd_ativo,
    ...
    {
        $this->produto = DBServicoProduto::findOrFail($id);
    ...
    {
        $produto = DBServicoProduto::find($id);
