...
class Servico extends Component
{
    ...
    public function gravar()
    {
        ...
        if($this->foto)
        {
            ...
            $img->resize(320, 320);
            $img->save('stg/imgs/prod/' . $nomearquivo);
        }
    ...
    {
        $servico = DBServicoProduto::findOrFail($id);
        $this->servicoId                        = $id;
    ...
    public function atualizar()
    {
        if ($this->servicoId)
        {
            $servico = DBServicoProduto::findOrFail($this->servicoId);
            $servico->update([
                'nome'                          => $this->bd_nome,
                'tipo'                          => $this->bd_tipo,
                'ativo'                         => $this->bd_ativo,
    ...
    public function deletar($id)
    {
        ...
        $filePath = public_path("stg/imgs/prod/{$servico->id}.png");
