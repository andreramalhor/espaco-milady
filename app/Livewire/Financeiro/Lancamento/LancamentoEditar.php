...
class LancamentoEditar extends Component
{
  ...
  public function mount($id)
  {
    ...
    {
      return redirect()->to(route('fin.lancamentos.abertas', $this->comissao->id_pessoa));
    }
  ...
  {
    return view('livewire/financeiro/lancamentos/lancamentos-editar')->layout('layouts/bootstrap');
  }
}
