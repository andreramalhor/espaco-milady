...
class LancamentoCriar2 extends Component
{
    public $tipo;
    public $id_banco;
    public $id_conta;
    ...
    public function mount()
    {
        ...
        $this->contas                = ContaContabil::pluck('titulo', 'id');
        $this->formas_pagamentos     = FormaPagamento::select('forma')->distinct()->get();
        $this->parcela               = 1;
    ...
    {
        return view('livewire/financeiro/lancamento/criar')->layout('layouts/bootstrap');
    }
